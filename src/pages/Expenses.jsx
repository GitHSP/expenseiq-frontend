...
export default function Expenses({ expenses, onEdit, onDelete, formatAmount }) {
  ...
  const filtered = expenses
    .filter(e => {
      ...
      const matchMonth = filterMonth === "All" || new Date(e.date).getMonth() === parseInt(filterMonth);
      ...
      <div style={{
        ...
        {(filterCat !== "All" || filterMonth !== "All" || search !== "") && (
          <button
            ...
            onClick={() => { setFilterCat("All"); setFilterMonth("All"); setSearch(""); }}
          >
            ✕ Clear
          </button>
        )}
      ...
      <div style={{
        ...
        {filtered.length === 0 ? (
          <div className="empty-state">
            ...
            <div style={{ fontWeight:600, color:"#ccc", marginBottom:4, fontSize:15 }}>
              No expenses found
            </div>
            ...
            <table style={{ width:"100%", borderCollapse:"collapse" }}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ ...tdStyle, maxWidth:200 }}>
                        ...
                        {exp.notes && (
                          <div style={{ fontSize:11, color:"#aaa", marginTop:2, overflow:"hidden", textOverflow:"ellipsis" }}>
                            {exp.notes}
                          </div>
                        )}
                      </td>
              ...
              <tfoot>
                <tr style={{ background:"#f6f8fa" }}>
                  <td colSpan={3} style={{ ...tdStyle, fontWeight:700, color:"#0d0d0d", borderTop:"1px solid #eaeaea", borderBottom:"none" }}>
